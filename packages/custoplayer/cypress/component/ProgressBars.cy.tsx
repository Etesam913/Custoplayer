...
describe('ProgressBars.cy.tsx', () => {
  ...
  it('renders progressBars buffered color', () => {
    ...
    cy.mount(
      <ProgressBars
        item={{ id: 'progressBar1', bufferedColor: bufferedColor }}
      />,
    );
    cy.dataCy('progressBuffer1').should(
      'have.css',
      'background-color',
      bufferedColor,
    );
    ...
    cy.mount(
      <ProgressBars
        item={{ id: 'progressBar2', bufferedColor: bufferedColor }}
      />,
    );
    cy.dataCy('progressBuffer2').should(
      'have.css',
      'background-color',
      bufferedColor,
    );
    ...
    cy.mount(
      <ProgressBars
        item={{ id: 'progressBar3', bufferedColor: bufferedColor }}
      />,
    );
    cy.dataCy('progressBuffer3').should(
      'have.css',
      'background-color',
      bufferedColor,
    );
  ...
  it('renders progressBar3 barBorderColor', () => {
    ...
    cy.dataCy('progressBar3')
      .children()
      .first()
      .should('have.css', 'border', `3px solid ${barBorderColor}`);
  });
  ...
  it('renders progressBars barColor', () => {
    ...
    cy.dataCy('progressBar1')
      .children()
      .first()
      .should('have.css', 'background-color', barColor);
